...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: user_welcompage.php");
    exit;
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT userid, firstname, username, password FROM user WHERE username = ?";
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            if($stmt->execute()){
                ...
                if($stmt->num_rows == 1){                    
                    ...
                    $stmt->bind_result($userid, $firstname,  $username, $hashed_password);

                    if($stmt->fetch()){
                        $response=password_verify($password1,$hashed_password);
                        if($password1){
